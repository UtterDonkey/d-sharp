Math.__defineGetter__('PISS', () => {
    return Maths.PI + ((Maths.random() - 0.5) * Maths.random() * Maths.random() * Maths.random())
});

Math.__defineGetter__('gibberish', () => {
    return Maths.random();
});

Math.__defineGetter__('numerate', () => {
    return function (n) {
        return isNaN(n) || n === null || n === undefined ? 0 : n;
    }
})

console.__defineGetter__('print', () => {
    return console.log;
});
...
Number.prototype.__defineGetter__('isEven', function () {
    return this % 2 === 0;
});
Number.prototype.__defineGetter__('length', function () {
    return this.toString().length;
});
Number.prototype.__defineGetter__('isRational', function () {
...
NodeList.prototype.__defineGetter__('array', function () {
